...
export const AVATAR_PRESETS: AvatarPreset[] = [
  ...
  { id: "avatar-65", file: "/agent-avatars/avatar-65.svg", label: "Half-Moon Headmaster", suggestedFor: [] },
  { id: "avatar-66", file: "/agent-avatars/avatar-66.svg", label: "He Who Shall Not Be Named", suggestedFor: [] },
  { id: "avatar-67", file: "/agent-avatars/avatar-67.svg", label: "Half-Blood Potions Master", suggestedFor: [] },
  { id: "avatar-68", file: "/agent-avatars/avatar-68.svg", label: "Keeper of Keys", suggestedFor: [] },
  { id: "avatar-69", file: "/agent-avatars/avatar-69.svg", label: "Grey Pilgrim", suggestedFor: [] },
  { id: "avatar-70", file: "/agent-avatars/avatar-70.svg", label: "Elven Archer", suggestedFor: [] },
  { id: "avatar-71", file: "/agent-avatars/avatar-71.svg", label: "Ranger of the North", suggestedFor: [] },
  { id: "avatar-72", file: "/agent-avatars/avatar-72.svg", label: "Green Swamp Sage", suggestedFor: [] },
  { id: "avatar-73", file: "/agent-avatars/avatar-73.svg", label: "Farm Boy Jedi", suggestedFor: [] },
  { id: "avatar-74", file: "/agent-avatars/avatar-74.svg", label: "Twin-Bun Princess", suggestedFor: [] },
  { id: "avatar-75", file: "/agent-avatars/avatar-75.svg", label: "Dark Father", suggestedFor: [] },
  { id: "avatar-76", file: "/agent-avatars/avatar-76.svg", label: "Wise Mentor", suggestedFor: [] },
  { id: "avatar-77", file: "/agent-avatars/avatar-77.svg", label: "Furry Copilot", suggestedFor: [] },
  { id: "avatar-78", file: "/agent-avatars/avatar-78.svg", label: "Plumber in Red", suggestedFor: [] },
  { id: "avatar-79", file: "/agent-avatars/avatar-79.svg", label: "Plumber in Green", suggestedFor: [] },
  { id: "avatar-80", file: "/agent-avatars/avatar-80.svg", label: "Mushroom Royalty", suggestedFor: [] },
  { id: "avatar-81", file: "/agent-avatars/avatar-81.svg", label: "Hylian Hero", suggestedFor: [] },
  { id: "avatar-82", file: "/agent-avatars/avatar-82.svg", label: "Electric Mascot", suggestedFor: [] },
  { id: "avatar-83", file: "/agent-avatars/avatar-83.svg", label: "Donut Devotee", suggestedFor: [] },
  { id: "avatar-84", file: "/agent-avatars/avatar-84.svg", label: "Underachiever & Proud", suggestedFor: [] },
  { id: "avatar-85", file: "/agent-avatars/avatar-85.svg", label: "Blue Tower", suggestedFor: [] },
  { id: "avatar-86", file: "/agent-avatars/avatar-86.svg", label: "Three-Circle Mouse", suggestedFor: [] },
  { id: "avatar-87", file: "/agent-avatars/avatar-87.svg", label: "Polka Dot Sweetheart", suggestedFor: [] },
  { id: "avatar-88", file: "/agent-avatars/avatar-88.svg", label: "Sailor Fowl", suggestedFor: [] },
  { id: "avatar-89", file: "/agent-avatars/avatar-89.svg", label: "Roof Dreamer", suggestedFor: [] },
  { id: "avatar-90", file: "/agent-avatars/avatar-90.svg", label: "Meddling Mutt", suggestedFor: [] },
  { id: "avatar-91", file: "/agent-avatars/avatar-91.svg", label: "Caped Crusader", suggestedFor: [] },
  { id: "avatar-92", file: "/agent-avatars/avatar-92.svg", label: "Last Son of Krypton", suggestedFor: [] },
  { id: "avatar-93", file: "/agent-avatars/avatar-93.svg", label: "Friendly Neighborhood Hero", suggestedFor: [] },
  { id: "avatar-94", file: "/agent-avatars/avatar-94.svg", label: "Tin Can Genius", suggestedFor: [] },
  { id: "avatar-95", file: "/agent-avatars/avatar-95.svg", label: "Star Spangled Soldier", suggestedFor: [] },
  { id: "avatar-96", file: "/agent-avatars/avatar-96.svg", label: "Hammer God", suggestedFor: [] },
  { id: "avatar-97", file: "/agent-avatars/avatar-97.svg", label: "Angry Green Smash", suggestedFor: [] },
  { id: "avatar-98", file: "/agent-avatars/avatar-98.svg", label: "Merc with a Mouth", suggestedFor: [] },
  { id: "avatar-99", file: "/agent-avatars/avatar-99.svg", label: "Amazon Warrior", suggestedFor: [] },
  { id: "avatar-100", file: "/agent-avatars/avatar-100.svg", label: "Clown Prince of Crime", suggestedFor: [] },
  ...
  { id: "avatar-108", file: "/agent-avatars/avatar-108.svg", label: "Jolly Gift-Giver", suggestedFor: [] },
  { id: "avatar-109", file: "/agent-avatars/avatar-109.svg", label: "Red-and-White Hider", suggestedFor: [] },
  { id: "avatar-110", file: "/agent-avatars/avatar-110.svg", label: "Patriotic Pointer", suggestedFor: [] },
  { id: "avatar-111", file: "/agent-avatars/avatar-111.svg", label: "Whip-Wielding Archaeologist", suggestedFor: [] },
  { id: "avatar-112", file: "/agent-avatars/avatar-112.svg", label: "Consulting Detective", suggestedFor: [] },
];
